...
public class EricsPacketEditor17 extends EricsPacketEditorBase {
    ...
    protected void removePlayer(final Player player) {
    	try {
            Field channelField = ((CraftPlayer)player).getHandle().playerConnection.networkManager.getClass().getDeclaredField("m");
